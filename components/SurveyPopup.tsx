      ...
      <div className="game-panel rounded-lg p-6 w-[min(92vw,32rem)] max-h-[90vh] overflow-y-auto text-left animate-in fade-in zoom-in duration-500">
        ...
        {step === 'q3' && (
          <div className="space-y-3">
            ...
            <button disabled={submitting} onClick={() => { setQ3('nah'); setStep('q4'); }} className="w-full text-left px-3 py-2 rounded-md text-sm transition-colors bg-slate-800/60 text-slate-100 hover:bg-slate-700/60">{t('survey.q3.nah')}</button>
