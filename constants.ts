...
export const SCENE_IMAGES = {
  cloud: "/scene/cloud.webp?v=3",
  tree: "/scene/tree.webp?v=3",
  house: "/scene/house.webp?v=3",
  sky: "/scene/sky.png?v=3",
  farHouse: "/scene/farHouse.webp?v=3",
  midHouse: "/scene/midHouse.webp?v=3",
  sidewalk: "/scene/sidewalk.webp?v=3",
  lamp: "/scene/lamp.webp?v=3"
};
